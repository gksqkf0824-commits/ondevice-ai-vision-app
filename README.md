...
| 탐지 | 버스 번호 OCR | ML Kit 한국어 OCR로 노선 번호 인식 |
| 안내 | 앞문 위치 안내 | 탐지된 버스에서 앞문 위치를 추정·음성 안내 |
...
프레임 간 탐지가 1~2프레임 끊겨도 박스가 유지되도록 3단계 IoU 매칭을 수행합니다.
...
버스 bbox 면적이 화면의 **12% 이상**일 때만 ML Kit OCR를 호출하고,
